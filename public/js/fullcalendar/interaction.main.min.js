    ...
    ***************************************************************************** */
    ...
    var y = 0, D = 0, w = !1, T = function () {
        ...
        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), a()
    ...
    }(t.ScrollController), C = function (e) {
        function r(n, r) {
    ...
    }(b), I = "function" == typeof performance ? performance.now : Date.now, P = function () {
        function e() {
            var e = this;
        ...
        return e.prototype.start = function (e, t) {
            ...
            for (var n = this.edgeThreshold, r = null, i = 0, o = this.scrollCaches; i < o.length; i++) {
                var a = o[i], l = a.clientRect, s = e - l.left, c = l.right - e, d = t - l.top, u = l.bottom - t;
            ...
            r.delay = null, r.minDistance = 0, r.touchScrollAllowed = !0, r.mirrorNeedsRevert = !1, r.isInteracting = !1, r.isDragging = !1, r.isDelayEnded = !1, r.isDistanceSurpassed = !1, r.delayTimeoutId = null, r.onPointerDown = function (e) {
                ...
                if (r.isInteracting) {
                    if (r.emitter.trigger("pointermove", e), !r.isDistanceSurpassed) {
                        var t = r.minDistance, n = void 0, i = e.deltaX, o = e.deltaY;
        ...
        return e.prototype.destroy = function () {
            ...
            for (var r = {left: e, top: n}, i = 0, o = this.scrollCaches; i < o.length; i++) {
                var a = o[i];
        ...
        return e.prototype.processFirstCoord = function (e) {
            ...
            var r = this, i = r.droppableStore, o = r.offsetTrackers, a = null;
            for (var l in i) {
                var s = i[l].component, c = o[l];
                if (c.isWithinClipping(e, n)) {
                    var d = c.computeLeft(), u = c.computeTop(), g = e - d, h = n - u, p = c.origRect,
                        v = p.right - p.left, f = p.bottom - p.top;
                    if (g >= 0 && g < v && h >= 0 && h < f) {
        ...
        function r(n) {
            ...
            r.handlePointerDown = function (e) {
                ...
                if (!r.dragging.pointer.wasTouchScroll) {
                    var n = r.hitDragging, i = n.initialHit, o = n.finalHit;
        ...
        function r(n) {
            ...
            r.dragSelection = null, r.handlePointerDown = function (e) {
                ...
                var i = r.component.calendar, o = null, a = !1;
                e && ((o = u(r.hitDragging.initialHit, e, i.pluginSystem.hooks.dateSelectionTransformers)) && r.component.isDateSelectionValid(o) || (a = !0, o = null)), o ? i.dispatch({
                    type: "SELECT_DATES",
                    selection: o
                }) : n || i.dispatch({type: "UNSELECT_DATES"}), a ? t.disableCursor() : t.enableCursor(), n || (r.dragSelection = o)
            ...
            var i = n.component, o = r.dragging = new L(i.el);
        ...
        function r(n) {
            ...
            i.subjectSeg = null, i.isDragging = !1, i.eventRange = null, i.relevantEvents = null, i.receivingCalendar = null, i.validMutation = null, i.mutatedRelevantEvents = null, i.handlePointerDown = function (e) {
                var n = e.origEvent.target, r = i, o = r.component, a = r.dragging, l = a.mirror, s = o.calendar,
                    c = i.subjectSeg = t.getElSeg(e.subjectEl), d = i.eventRange = c.eventRange,
                ...
                var n = i.component.calendar, r = i.eventRange, o = r.instance.instanceId;
                e.isTouch ? o !== i.component.props.eventSelection && n.dispatch({
                    type: "SELECT_EVENT",
                    eventInstanceId: o
                }) : n.dispatch({type: "UNSELECT_EVENT"}), i.isDragging && (n.unselect(e), n.publiclyTrigger("eventDragStart", [{
                    el: i.subjectSeg.el,
                ...
                if (i.isDragging) {
                    var r = i.relevantEvents, o = i.hitDragging.initialHit, a = i.component.calendar, l = null,
                        s = null, d = null, u = !1, h = {
                            affectedEvents: r,
                ...
                if (i.isDragging) {
                    var n = i.component.calendar, r = i.component.view, o = i.receivingCalendar, a = i.eventRange.def,
                        l = i.eventRange.instance, s = new t.EventApi(n, a, l), c = i.relevantEvents,
                        d = i.mutatedRelevantEvents, u = i.hitDragging.finalHit;
            ...
            var o = i.component, a = i.dragging = new L(o.el);
        ...
        return n(r, e), r.prototype.destroy = function () {
            ...
            var r = this.component.calendar, i = this.receivingCalendar;
        ...
        function r(n) {
            ...
            r.draggingSeg = null, r.eventRange = null, r.relevantEvents = null, r.validMutation = null, r.mutatedRelevantEvents = null, r.handlePointerDown = function (e) {
                ...
                var n = r.component.calendar, i = r.eventRange;
                ...
                var o = r.component.calendar, a = r.relevantEvents, l = r.hitDragging.initialHit,
                    s = r.eventRange.instance, d = null, u = null, g = !1, h = {
                        affectedEvents: a,
                        mutatedEvents: t.createEmptyEventStore(),
                        isEvent: !0,
                ...
                e && (d = p(l, e, i.subjectEl.classList.contains("fc-start-resizer"), s.range, o.pluginSystem.hooks.eventResizeJoinTransforms)), d && (u = t.applyMutationToEventStore(a, o.eventUiBases, d, o), h.mutatedEvents = u, r.component.isInteractionValid(h) || (g = !0, d = null, u = null, h.mutatedEvents = null)), u ? o.dispatch({
                    ...
                    state: h
                }) : o.dispatch({type: "UNSET_EVENT_RESIZE"}), g ? t.disableCursor() : t.enableCursor(), n || (d && c(l, e) && (d = null), r.validMutation = d, r.mutatedRelevantEvents = u)
            }, r.handleDragEnd = function (e) {
                var n = r.component.calendar, i = r.component.view, o = r.eventRange.def, a = r.eventRange.instance,
        ...
        function e(e) {
            ...
            this.isRecentPointerDateSelect = !1, this.onSelect = function (e) {
                ...
                if (!o.wasTouchScroll) {
                    ...
                    a.eventSelection && !t.elementClosest(o.downEl, V.SELECTOR) && i.dispatch({type: "UNSELECT_EVENT"})
                }
        ...
        function e(e, n) {
            ...
            this.receivingCalendar = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                var o = r.hitDragging.dragging, a = null, l = null, s = !1, c = {
                ...
                var n = r, i = n.receivingCalendar, o = n.droppableEvent;
                if (r.clearDrag(), i && o) {
                    var a = r.hitDragging.finalHit, l = a.component.view, s = r.dragMeta,
    ...
    }(), W = t.createPlugin({componentInteractions: [H, N, V, Y], calendarInteractions: [_], elementDraggingImpl: L});
    e.Draggable = U, e.FeaturefulElementDragging = L, e.PointerDragging = T, e.ThirdPartyDraggable = q, e.default = W, Object.defineProperty(e, "__esModule", {value: !0})
});