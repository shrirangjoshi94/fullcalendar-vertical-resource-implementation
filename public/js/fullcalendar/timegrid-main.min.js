    ...
    ***************************************************************************** */
    var u = function (e, t) {
        ...
        return i(r, e), r.prototype.attachSegs = function (e, t) {
            ...
            var t = this, r = t.timeGrid, i = t.segsByCol, n = r.colCnt;
            if (r.computeSegVerticals(e), i) for (var o = 0; o < n; o++) this.computeSegHorizontals(i[o])
        }, r.prototype.assignSegSizes = function (e) {
            var t = this, r = t.timeGrid, i = t.segsByCol, n = r.colCnt;
            if (r.assignSegVerticals(e), i) for (var o = 0; o < n; o++) this.assignSegCss(i[o])
            ...
            var i, n, o, s = e.eventRange, a = s.def, l = s.ui, d = a.allDay, c = l.startEditable,
                h = e.isStart && l.durationEditable && this.context.options.eventResizableFromStart,
                u = e.isEnd && l.durationEditable, p = this.getSegClasses(e, c, h || u, r),
            ...
            var t, r, i = this.context.options.slotEventOverlap, n = e.backwardCoord, o = e.forwardCoord,
                s = this.timeGrid.generateSegVerticalCss(e), a = this.timeGrid.isRtl;
    ...
    }(t.FgEventRenderer), g = function (e) {
        function t() {
    ...
    }(t.FillRenderer), y = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}], v = function (e) {
        function n(r, i, n) {
            var o = e.call(this, r, i) || this;
            o.isSlatSizesDirty = !1, o.isColSizesDirty = !1, o.renderSlats = t.memoizeRendering(o._renderSlats);
            var s = o.eventRenderer = new f(o), a = o.fillRenderer = new m(o);
        ...
        return i(n, e), n.prototype.processOptions = function () {
            var e, r, i = this.opt("slotDuration"), n = this.opt("snapDuration");
            ...
            var r, i, n;
            for (r = y.length - 1; r >= 0; r--) if (i = t.createDuration(y[r]), null !== (n = t.wholeDivideDurations(i, e)) && n > 1) return i;
            return e
            ...
            var t = this, r = t.fillRenderer, i = t.eventRenderer, n = t.mirrorRenderer;
            ...
            var n = this, o = n.theme, s = n.dateEnv, a = n.view, l = new r.DayBgRow(this.context);
            ...
            var i = this, n = i.dateEnv, o = i.snapsPerSlot, s = i.slatPositions, a = i.colPositions,
                l = a.leftToIndex(e), d = s.topToIndex(r);
            if (null != l && null != d) {
                var c = s.tops[d], h = s.getHeight(d), u = (r - c) / h, p = Math.floor(u * o), f = d * o + p,
                    g = this.props.cells[l].date,
                    m = t.addDurations(this.props.dateProfile.minTime, t.multiplyDuration(this.snapDuration, f)),
                    y = n.add(g, m);
                return {
                    col: l,
                    dateSpan: {range: {start: y, end: n.add(y, this.snapDuration)}, allDay: !1},
                    dayEl: this.colEls[l],
                    relativeRect: {left: a.lefts[l], right: a.rights[l], top: c, bottom: c + h}
                }
            }
    ...
    }(t.Splitter), C = t.createFormatter({week: "short"}), b = function (e) {
        function n(i, n, o, s) {
            var a = e.call(this, i, n, o, s) || this;
            a.splitter = new S, a.renderHeadIntroHtml = function () {
                var e, r = a, i = r.theme, n = r.dateEnv, o = a.props.dateProfile.renderRange,
    ...
    var E = function (e) {
        function r(r, i) {
            ...
            return n.buildDayRanges = t.memoize(c), n.slicer = new D, n.timeGrid = i, r.calendar.registerInteractiveComponent(n, {el: n.timeGrid.el}), n
        }
        ...
        return i(r, e), r.prototype.destroy = function () {
            ...
            var t = e.dateProfile, r = e.dayTable, i = this.dayRanges = this.buildDayRanges(r, t, this.dateEnv);
        ...
        return i(n, e), n.prototype.destroy = function () {
            ...
            var r = this.props.dateProfile, i = this.buildDayTable(r, this.dateProfileGenerator),
        ...
        views: {
            timeGrid: {class: w, allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0},
            timeGridDay: {type: "timeGrid", duration: {days: 1}},
            timeGridWeek: {type: "timeGrid", duration: {weeks: 1}}
        }
    });
    e.AbstractTimeGridView = b, e.TimeGrid = v, e.TimeGridSlicer = D, e.TimeGridView = w, e.buildDayRanges = c, e.buildDayTable = h, e.default = G, Object.defineProperty(e, "__esModule", {value: !0})
});