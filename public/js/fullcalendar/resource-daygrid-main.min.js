...
!function (e, r) {
    ...
    function a(e, r, i, a) {
        ...
        return a ? new t.DayResourceTable(s, i) : new t.ResourceDayTable(s, i)
    }

    var s = "default" in t ? t["default"] : t, n = "default" in o ? o["default"] : o, l = function (e, r) {
        ...
        function a(r, o) {
            var i = e.call(this, r, o.el) || this;
            return i.splitter = new t.VResourceSplitter, i.slicers = {}, i.joiner = new u, i.dayGrid = o, r.calendar.registerInteractiveComponent(i, {el: i.dayGrid.el}), i
        }

        return i(a, e), a.prototype.destroy = function () {
            e.prototype.destroy.call(this), this.calendar.unregisterInteractiveComponent(this)
        }, a.prototype.render = function (e) {
            var t = this, i = this.dayGrid, a = e.dateProfile, s = e.resourceDayTable, n = e.nextDayThreshold,
                l = this.splitter.splitProps(e);
            this.slicers = r.mapHash(l, function (e, r) {
                return t.slicers[r] || new o.DayGridSlicer
            });
            var d = r.mapHash(this.slicers, function (e, r) {
                return e.sliceProps(l[r], a, n, i, s.dayTable)
            });
            i.allowAcrossResources = 1 === s.dayTable.colCnt, i.receiveProps(c({}, this.joiner.joinProps(d, s), {
                dateProfile: a,
                cells: s.cells,
                isRigid: e.isRigid
            }))
        ...
        }, a.prototype.queryHit = function (e, r) {
    ...
    }(r.DateComponent), u = function (e) {
        function r() {
            return null !== e && e.apply(this, arguments) || this
        }

        return i(r, e), r.prototype.transformSeg = function (e, r, t) {
            var o = r.computeColRanges(e.firstCol, e.lastCol, t);
            return o.map(function (r) {
                return c({}, e, r, {isStart: e.isStart && r.isStart, isEnd: e.isEnd && r.isEnd})
            })
        }, r
    }(t.VResourceJoiner), y = function (e) {
        function o(o, i, s, n) {
            var l = e.call(this, o, i, s, n) || this;
            return l.flattenResources = r.memoize(t.flattenResources), l.buildResourceDayTable = r.memoize(a), l.resourceOrderSpecs = r.parseFieldSpecs(l.opt("resourceOrder")), l.opt("columnHeader") && (l.header = new t.ResourceDayHeader(l.context, l.el.querySelector(".fc-head-container"))), l.resourceDayGrid = new d(o, l.dayGrid), l
        }

        return i(o, e), o.prototype.destroy = function () {
            e.prototype.destroy.call(this), this.header && this.header.destroy(), this.resourceDayGrid.destroy()
        }, o.prototype.render = function (r) {
            e.prototype.render.call(this, r);
            var t = this.flattenResources(r.resourceStore, this.resourceOrderSpecs),
                o = this.buildResourceDayTable(this.props.dateProfile, this.dateProfileGenerator, t, this.opt("datesAboveResources"));
    ...
    }(o.AbstractDayGridView), p = r.createPlugin({
        deps: [s, n],
    ...
    e.ResourceDayGrid = d, e.ResourceDayGridView = y, e["default"] = p, Object.defineProperty(e, "__esModule", {value: !0})
});/*!
FullCalendar Resource Day Grid Plugin v4.2.0
Docs & License: https://fullcalendar.io/scheduler
(c) 2019 Adam Shaw
